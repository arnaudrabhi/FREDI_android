...
public class ListBordereauxActivity extends AppCompatActivity {


    ListView myListView;  // La liste des lignes de frais
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_bordereaux);
